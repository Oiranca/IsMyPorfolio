...
export const experience: Experience = [{
    ...
    logo: 'experience/logo_ecommerce_white.png',
    title: 'Ecommerce',
    ...
    logo: 'experience/logo_Moviesforworld_white.png',
